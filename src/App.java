...
import com.br.rpeixoto.dao.ClienteMapDAO;
import com.br.rpeixoto.dao.IClienteDAO;
...
public class App {
    ...
    private static void cadastrar(String dados) {
        ...
        if (!isCamposValidos(dadosSeparados)) {
            Cliente cliente = new Cliente(dadosSeparados[0], dadosSeparados[1],
                    dadosSeparados[2], dadosSeparados[3],
                    dadosSeparados[4], dadosSeparados[5], dadosSeparados[6]);
            Boolean isCadastrado = iClienteDAO.registrar(cliente);
    ...
    private static boolean isCamposValidos(String... dadosSeparados) {
